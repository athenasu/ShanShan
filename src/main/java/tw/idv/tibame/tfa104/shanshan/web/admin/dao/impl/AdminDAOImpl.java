...
public class AdminDAOImpl implements AdminDAO{
	...
	@Override 
		...
		return session.createNativeQuery("SELECT "+
											"article_report_id as articleReportId, "+
											"member_id as memberId, "+
											"article_id as articleId, "+
											"article_report_status as articleReportStatus, "+
											"article_report_reason as articleReportReason, "+
											"article_report_date as articleReportDate, "+
											"case_done as caseDone "+
											"FROM article_report "+
										"WHERE article_report_status = :articleReportStatus", ArticleReportBO.class)
				.setParameter("articleReportStatus", articleReportStatus).list();
	}
	...
	public List<ArticleReportDetailBO> findArticleReportById(Integer articleReportId){
		Session session = sessionFactory.getCurrentSession();
		return session.createNativeQuery("SELECT "+
		        							"a.article_report_id as articleReportId, "+
		        							"a.member_id as memberId, "+
		        							"a.article_id as articleId, "+
		        							"a.article_report_date as articleReportDate, "+
		        							"a.article_report_status as articleReportStatus, "+
		        							"a.article_report_reason as articleReportReason, "+
		        							"a.case_done as caseDone, "+
		        							"b.article_title as articleTitle, "+
		        							"b.article_content as articleContent, "+
		        							"c.member_name as memberName, "+
		        							"c.member_username as memberUsername "+
