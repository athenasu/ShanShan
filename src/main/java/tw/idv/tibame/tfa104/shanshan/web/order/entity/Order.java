...
public class Order implements Serializable{
	...
	public Order(Integer order_id, Integer member_id, Date order_created_date, String order_member_address,
			String order_member_name, Integer order_member_phone, Integer order_status, Integer point_used, Integer order_sum_before,
			Integer order_sum_after, Date order_shipped_date, Integer ship_number, Integer payment_status) {
		super();
